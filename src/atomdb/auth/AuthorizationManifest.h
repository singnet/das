...
class AuthorizationManifest {
   public:
    ...
    const vector<atomdb_api_types::AccessPermissionEntry>& entries(const string& public_key);
   ...
   private:
    ...
    void create_document(const string& public_key,
                         const atomdb_api_types::AccessPermissionEntry& entry);
    atomdb_api_types::AccessPermissionDocument* find_document(const string& public_key,
                                                              const string& caller);
};
