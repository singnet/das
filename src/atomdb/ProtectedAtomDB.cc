...
bool ProtectedAtomDB::can_read(const Keychain& keychain, const string& handle) {
...
set<string> ProtectedAtomDB::filter_handles(set<string> original_handles, const Keychain& keychain) {
