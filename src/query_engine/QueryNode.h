 ...
 *
 */
template <class AnswerType> class QueryNode : public DistributedAlgorithmNode {
public:
...
template <class AnswerType> class QueryAnswerFlow : public Message {
public:
...
template <class AnswerType> class QueryAnswerTokensFlow : public Message {
public:
...
template <class AnswerType> class QueryAnswersFinished : public Message {
public:
