...
Iterator<AnswerType>::Iterator(QueryElement *precedent,
                               bool delete_precedent_on_destructor)
    : Sink<AnswerType>(precedent, "Iterator(" + precedent->id + ")",
                       delete_precedent_on_destructor) {}

template <class AnswerType> Iterator<AnswerType>::~Iterator() {}

template <class AnswerType> bool Iterator<AnswerType>::finished() {
...
template <class AnswerType> QueryAnswer *Iterator<AnswerType>::pop() {
