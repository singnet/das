...
struct AtomDBTrampoline : AtomDB {
  ...
  void delete_atom(const string &handle) override {
    NB_OVERRIDE_PURE(delete_atom, handle);
  }
  ...
  const string create_field_index(
    ...
    NB_OVERRIDE_PURE(create_field_index, atom_type, fields, named_type,
  ...
  shared_ptr<Link> _build_link(const Link &link_params,
                               bool is_toplevel = true) override {
