...
NB_MODULE(ext, m) {
  ...
  nb::class_<AtomDB, AtomDBTrampoline>(database, "AtomDB")
      ...
      .def_static("build_node_handle", &AtomDB::build_node_handle,
                  "node_type"_a, "node_name"_a)
      .def_static("node_handle", // retrocompatibility
                  &AtomDB::build_node_handle, "node_type"_a, "node_name"_a)
      .def_static(
          "build_link_handle",
      ...
      .def_static(
          ...
          "link_type"_a, "target_handles"_a)
      .def_static(
          "build_link_handle",
      ...
      .def_static(
          ...
          "link_type"_a, "target_handle"_a)
      .def("node_exists", &AtomDB::node_exists, "node_type"_a, "node_name"_a)
      .def("link_exists", &AtomDB::link_exists, "link_type"_a,
           "target_handles"_a)
      .def(
          "get_atom",
          [](AtomDB &self, const string &handle, bool no_target_format = false,
             bool targets_document = false, bool deep_representation = false,
          ...
          "handle"_a, nb::kw_only(), "no_target_format"_a = false,
          "targets_document"_a = false, "deep_representation"_a = false,
          "_"_a = nb::kwargs())
      .def("get_node_handle", &AtomDB::get_node_handle, "node_type"_a,
           "node_name"_a)
      .def("get_node_name", &AtomDB::get_node_name, "node_handle"_a)
      .def("get_node_type", &AtomDB::get_node_type, "node_handle"_a)
      .def("get_node_by_name", &AtomDB::get_node_by_name, "node_type"_a,
           "substring"_a)
      .def("get_atoms_by_field", &AtomDB::get_atoms_by_field, "query"_a)
      .def("get_atoms_by_index", &AtomDB::get_atoms_by_index, "index_id"_a,
           "query"_a, "cursor"_a = 0, "chunk_size"_a = 500)
      ...
      .def("get_node_by_name_starting_with",
           &AtomDB::get_node_by_name_starting_with, "node_type"_a,
           "startswith"_a)
      .def("get_all_nodes_handles", &AtomDB::get_all_nodes_handles,
           "node_type"_a)
      .def("get_all_nodes_names", &AtomDB::get_all_nodes_names, "node_type"_a)
      .def(
          "get_all_links",
          [](AtomDB &self, const string &link_type,
             const nb::kwargs &_ = {}) -> const StringUnorderedSet {
            return self.get_all_links(link_type);
          },
          "link_type"_a, "_"_a = nb::kwargs())
      .def("get_link_handle", &AtomDB::get_link_handle, "link_type"_a,
           "target_handles"_a)
      ...
      .def(
          ...
          [](AtomDB &self, const string &atom_handle, bool handles_only = true,
             const nb::kwargs &_ = {}) -> const StringList {
            return self.get_incoming_links_handles(
                atom_handle, {handles_only : handles_only});
          },
          "atom_handle"_a, nb::kw_only(), "handles_only"_a = true,
          "_"_a = nb::kwargs())
      .def(
          "get_incoming_links_atoms",
          [](AtomDB &self, const string &atom_handle,
             bool no_target_format = false, bool targets_document = false,
             bool deep_representation = false, bool handles_only = false,
          ...
          "atom_handle"_a, nb::kw_only(), "no_target_format"_a = false,
          "targets_document"_a = false, "deep_representation"_a = false,
          "handles_only"_a = false, "_"_a = nb::kwargs())
      .def(
          "get_matched_links",
          [](AtomDB &self, const string &link_type,
             const StringList &target_handles, bool toplevel_only = false,
             const nb::kwargs &_ = {}) -> const StringUnorderedSet {
            return self.get_matched_links(link_type, target_handles,
                                          {toplevel_only : toplevel_only});
          },
          "link_type"_a, "target_handles"_a, nb::kw_only(),
          "toplevel_only"_a = false, "_"_a = nb::kwargs())
      .def(
          "get_matched_type_template",
          [](AtomDB &self, const StringList &_template,
             bool toplevel_only = false,
             const nb::kwargs &_ = {}) -> const StringUnorderedSet {
            return self.get_matched_type_template(
                _template, {toplevel_only : toplevel_only});
          },
          "_template"_a, nb::kw_only(), "toplevel_only"_a = false,
          "_"_a = nb::kwargs())
      .def(
          "get_matched_type",
          [](AtomDB &self, const string &link_type, bool toplevel_only = false,
             const nb::kwargs &_ = {}) -> const StringUnorderedSet {
            return self.get_matched_type(link_type,
                                         {toplevel_only : toplevel_only});
          },
          "link_type"_a, nb::kw_only(), "toplevel_only"_a = false,
          "_"_a = nb::kwargs())
      .def("get_atom_type", &AtomDB::get_atom_type, "handle"_a)
      .def(
          "count_atoms",
          [](const AtomDB &self,
             const optional<const nb::dict> &parameters =
                 nullopt) -> const unordered_map<string, int> {
      ...
      .def("create_field_index", &AtomDB::create_field_index, "atom_type"_a,
           "fields"_a, "named_type"_a = "", "composite_type"_a = nullopt,
      ...
      .def(
          "_reformat_document",
          [](const AtomDB &self, const shared_ptr<const Atom> &document,
             bool no_target_format = false, bool targets_document = false,
             bool deep_representation = false, const nb::kwargs &_ = {}) {
          ...
          "document"_a, nb::kw_only(), "no_target_format"_a = false,
          "targets_document"_a = false, "deep_representation"_a = false,
          "_"_a = nb::kwargs())
      .def("_build_node", &AtomDBPublicist::_build_node, "node_params"_a)
      .def("_build_link", &AtomDBPublicist::_build_link, "link_params"_a,
           "is_toplevel"_a = true)
  ...
  nb::class_<InMemoryDB, AtomDB>(adapters, "InMemoryDB")
      ...
      .def("__repr__",
           [](const InMemoryDB &self) -> string {
             return "<Atom database InMemory>";
           })
      .def("__str__", [](const InMemoryDB &self) -> string {
        return "<Atom database InMemory>";
      });
  // ---------------------------------------------------------------------------------------------
  ...
  nb::exception<InvalidOperationException>(exceptions,
  ...
  nb::class_<Atom>(document_types, "Atom")
      .def_rw("_id", &Atom::_id)
      .def_prop_ro(
          "id", // read-only property for having access to `_id` as `id`
  ...
  nb::class_<Node, Atom>(document_types, "Node")
      .def(
          ...
          "type"_a, "name"_a, "custom_attributes"_a = CustomAttributes{})
      .def(nb::init<const string &, // _id
                    ...
                    const string &, // name
                    const CustomAttributes &>(),
           "_id"_a, "handle"_a, "composite_type_hash"_a, "named_type"_a,
           "name"_a, "custom_attributes"_a = CustomAttributes{})
  ...
  nb::class_<Link, Atom>(document_types, "Link")
      .def(
          ...
          "type"_a, "targets"_a, "custom_attributes"_a = CustomAttributes{})
      .def("__init__", &helpers::init_link, "_id"_a, "handle"_a,
           "composite_type_hash"_a, "named_type"_a, "composite_type"_a,
           "named_type_hash"_a, "targets"_a, "is_toplevel"_a,
      ...
      .def_prop_rw(
          ...
          [](Link &self, const nb::list &composite_type) {
            self.composite_type =
                helpers::pylist_to_composite_type(composite_type);
          })
