...
shared_ptr<LeadershipBroker>
LeadershipBroker::factory(LeadershipBrokerType instance_type) {
  switch (instance_type) {
  case LeadershipBrokerType::SINGLE_MASTER_SERVER: {
    return shared_ptr<LeadershipBroker>(new SingleMasterServer());
  }
  default: {
    Utils::error("Invalid LeadershipBrokerType: " +
...
void LeadershipBroker::set_message_broker(
