...
public:
  ...
  static RequestSelector *factory(SelectorType instance_type,
                                  unsigned int thread_id, SharedQueue *stimulus,
...
protected:
  RequestSelector(unsigned int thread_id, SharedQueue *stimulus,
...
public:
  ...
  EvenThreadCount(unsigned int thread_id, SharedQueue *stimulus,
                  SharedQueue *correlation); /// Basic constructor.
