...
public:
  ...
  public:
    ...
    ImportanceType
        stimuli_to_spread; /// Amount of importance this node will spread in the
   ...
   */
  Edge *add_asymmetric_edge(string handle1, string handle2, Node *node1,
                            Node *node2);
   ...
   */
  void add_symmetric_edge(string handle1, string handle2, Node *node1,
                          Node *node2);
  ...
  void visit_nodes(bool keep_root_locked,
                   bool (*visit_function)(HandleTrie::TrieNode *node,
                                          void *data),
                   void *data);
