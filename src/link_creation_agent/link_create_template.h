 ...
 * to a CustomField.
 */
using CustomFieldTypes =
    std::variant<std::string, std::shared_ptr<CustomField>>;
/**
 ...
 */
using LinkCreateTemplateTypes =
    std::variant<Variable, Node, std::shared_ptr<LinkCreateTemplate>>;
