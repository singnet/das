...
void ConfigFile::load() { this->config_map = Utils::parse_config(this->file_path); }
...
shared_ptr<Config> ConfigFileSingleton::get_instance() { return ConfigFileSingleton::instance; }
