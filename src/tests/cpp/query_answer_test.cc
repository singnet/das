...
TEST(QueryAnswer, handles_answer_basics) {
    ...
    EXPECT_TRUE(query_answer1.handles == set<string>({"h1"}));
    query_answer1.add_handle("hx");
    EXPECT_EQ(query_answer1.handles.size(), 2);
    EXPECT_TRUE(query_answer1.handles == set<string>({"h1", "hx"}));
    ...
    EXPECT_TRUE(query_answer2.handles == set<string>({"h1", "h2", "hx"}));
    ...
    EXPECT_TRUE(query_answer3->handles == set<string>({"h1", "h2", "hx"}));
