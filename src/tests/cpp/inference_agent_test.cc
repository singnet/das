...
TEST_F(InferenceAgentTest, TestInferenceRequests) {
    ...
    EXPECT_EQ(Utils::join(dic_request, ' '),
              "OR 2 LINK_TEMPLATE Expression 3 NODE Symbol IMPLICATION ATOM handle1 ATOM handle2 LINK_TEMPLATE Expression 3 NODE Symbol EQUIVALENCE ATOM handle1 ATOM handle2");
    ...
    EXPECT_EQ(Utils::join(dic_request, ' '),
              "OR 6 AND 2 LINK_TEMPLATE Expression 3 NODE Symbol IMPLICATION ATOM handle3 VARIABLE V1 LINK_TEMPLATE Expression 3 NODE Symbol IMPLICATION VARIABLE V1 ATOM handle4 AND 2 LINK_TEMPLATE Expression 3 NODE Symbol EQUIVALENCE ATOM handle3 VARIABLE V1 LINK_TEMPLATE Expression 3 NODE Symbol IMPLICATION VARIABLE V1 ATOM handle4 AND 2 LINK_TEMPLATE Expression 3 NODE Symbol IMPLICATION ATOM handle3 VARIABLE V1 LINK_TEMPLATE Expression 3 NODE Symbol EQUIVALENCE VARIABLE V1 ATOM handle4 AND 2 LINK_TEMPLATE Expression 3 NODE Symbol EQUIVALENCE ATOM handle3 VARIABLE V1 LINK_TEMPLATE Expression 3 NODE Symbol EQUIVALENCE VARIABLE V1 ATOM handle4 LINK_TEMPLATE Expression 3 NODE Symbol IMPLICATION ATOM handle3 ATOM handle4 LINK_TEMPLATE Expression 3 NODE Symbol EQUIVALENCE ATOM handle3 ATOM handle4");
    ...
    EXPECT_EQ(Utils::join(dic_request, ' '),
              "OR 2 LINK_TEMPLATE Expression 3 NODE Symbol IMPLICATION ATOM handle5 ATOM handle6 LINK_TEMPLATE Expression 3 NODE Symbol EQUIVALENCE ATOM handle5 ATOM handle6");
}
