...
TEST(LinkTemplate, basics) {
    ...
    LinkTemplate* inner_template_ptr =
        new LinkTemplate(expression, {similarity, v1, v2}, "", 0.0, false, false, false, false);
    shared_ptr<LinkTemplate> inner_template(inner_template_ptr);
    LinkTemplate* outter_template_ptr =
        new LinkTemplate(expression, {odd_link, inner_template}, "", 0.0, false, false, false, false);
...
TEST(LinkTemplate, nested_variables) {
    ...
    LinkTemplate* human_template =
        new LinkTemplate(expression, {similarity, v1, human}, "", 0.0, false, false, false, false);
