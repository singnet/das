...
TEST(RequestSelectorTest, even_thread_count) {
    ...
    RequestSelector* selector0 =
        RequestSelector::factory(SelectorType::EVEN_THREAD_COUNT, 0, stimulus, correlation);
    RequestSelector* selector1 =
        RequestSelector::factory(SelectorType::EVEN_THREAD_COUNT, 1, stimulus, correlation);
